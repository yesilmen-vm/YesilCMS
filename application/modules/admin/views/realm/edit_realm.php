      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          ...
          <div class="uk-width-auto">
            <a href="<?= base_url('admin/realms'); ?>" class="uk-icon-button"><i class="fas fa-arrow-left"></i></a>
          </div>
        </div>
            ...
            <div class="uk-margin-small">
              <div class="uk-grid uk-grid-small" data-uk-grid>
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" id="soap_username" value="<?= $this->admin_model->getRealmSpecifyConsoleUser($idlink); ?>" placeholder="soap_username" required>
                  </div>
                </div>
                <div class="uk-inline uk-width-1-2@s">
                  <label class="uk-form-label"><?= $this->lang->line('placeholder_soap_password'); ?></label>
                  <div class="uk-form-controls">
                    <input class="uk-input" type="password" id="soap_password" value="<?= $this->admin_model->getRealmSpecifyConsolePass($idlink); ?>" placeholder="soap_password" required>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <select class="uk-select" id="emulator" required>
                      <option value="MaNGOS" <?= $this->admin_model->getRealmSpecifyEmulator($idlink) == 'MaNGOS' ? 'selected' : '' ?>>vMaNGOS / CMaNGOS</option>
    ...
    var csrfHash = "<?= $this->security->get_csrf_hash() ?>";
      ...
      function UpdateRealmForm(e) {
        ...
        $.ajax({
          ...
          method:"POST",
          data:{id, realmid, soaphost, soapport, soapuser, soappass, charhost, chardb, charuser, charpass, emulator, [globalThis.csrfName]: globalThis.csrfHash},
          dataType:"text",
          beforeSend: function(){
            $.amaran({
              'theme': 'awesome info',
