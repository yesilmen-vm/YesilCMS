            ...
            <div class="uk-margin-small">
              <div class="uk-grid uk-grid-small" data-uk-grid>
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" id="soap_username" placeholder="soap_username" required>
                  </div>
                </div>
                <div class="uk-inline uk-width-1-2@s">
                  <label class="uk-form-label"><?= $this->lang->line('placeholder_soap_password'); ?></label>
                  <div class="uk-form-controls">
                    <input class="uk-input" type="password" id="soap_password" placeholder="soap_password" required>
                  </div>
                </div>
              </div>
            </div>
    ...
    var csrfHash = "<?= $this->security->get_csrf_hash() ?>";
      ...
      function AddRealmForm(e) {
        ...
        $.ajax({
          ...
          method:"POST",
          data:{realmid, soaphost, soapport, soapuser, soappass, charhost, chardb, charuser, charpass, emulator, [globalThis.csrfName]: globalThis.csrfHash},
          dataType:"text",
          beforeSend: function(){
            $.amaran({
              'theme': 'awesome info',
