      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          ...
          <div class="uk-width-auto">
            <a href="<?= base_url('admin/store'); ?>" class="uk-icon-button"><i class="fas fa-arrow-left"></i></a>
          </div>
        </div>
                  ...
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <select class="uk-select" id="store_category_realm">
                        ...
                        <option value="<?= $MultiRealm->realmID ?>" <?php if ($this->admin_model->getStoreCategoryRealm($idlink) == $MultiRealm->realmID) {
                            echo 'selected';
                        } ?>><?= $this->wowrealm->getRealmName($MultiRealm->realmID); ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
    ...
    var csrfHash = "<?= $this->security->get_csrf_hash() ?>";
      ...
      function UpdateCategoryForm(e) {
        ...
        $.ajax({
          ...
          method:"POST",
          data:{id, name, route, realm, [globalThis.csrfName]: globalThis.csrfHash},
          dataType:"text",
          beforeSend: function(){
            $.amaran({
              'theme': 'awesome info',
