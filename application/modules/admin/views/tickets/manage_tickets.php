      ...
      <div class="uk-width-1-4@s">
        <div class="uk-card uk-card-secondary">
          <ul class="uk-nav uk-nav-default">
            ...
            <li class="uk-active"><a href="<?= base_url('admin/tickets'); ?>"><i class="fas fa-circle-down"></i> <?= $this->lang->line('admin_nav_realms') ?></a></li>
            <?php endif; ?>
            <?php foreach ($this->wowrealm->getRealms()->result() as $link): ?>
