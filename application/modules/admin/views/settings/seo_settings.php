                        ...
                        <div class="uk-margin-small">
                            ...
                            <div class="uk-form-controls">
                                <select class="uk-select" id="seo_metastatus">
                                    <option value="TRUE" <?php if ($this->config->item('seo_meta_enable') == true) {
                                        echo 'selected';
                                    } ?>><?= $this->lang->line('option_enabled'); ?></option>
                                    <option value="FALSE" <?php if ($this->config->item('seo_meta_enable') == false) {
                                        echo 'selected';
                        ...
                        <div class="uk-margin-small">
                            ...
                            <div class="uk-form-controls">
                                <select class="uk-select" id="seo_twitterstatus">
                                    <option value="TRUE" <?php if ($this->config->item('seo_twitter_enable') == true) {
                                        echo 'selected';
                                    } ?>><?= $this->lang->line('option_enabled'); ?></option>
                                    <option value="FALSE" <?php if ($this->config->item('seo_twitter_enable') == false) {
                                        echo 'selected';
                                    } ?>><?= $this->lang->line('option_disabled'); ?></option>
                                </select>
                            </div>
                        ...
                        <div class="uk-margin-small">
                            ...
                            <div class="uk-form-controls">
                                <select class="uk-select" id="seo_graphstatus">
                                    <option value="TRUE" <?php if ($this->config->item('seo_og_enable') == true) {
                                        echo 'selected';
                                    } ?>><?= $this->lang->line('option_enabled'); ?></option>
                                    <option value="FALSE" <?php if ($this->config->item('seo_og_enable') == false) {
                                        echo 'selected';
                                    } ?>><?= $this->lang->line('option_disabled'); ?></option>
                                </select>
                            </div>
