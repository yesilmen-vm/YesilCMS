                        ...
                        <div class="uk-margin-small">
                            <div class="uk-grid uk-grid-small" data-uk-grid>
                                ...
                                <div class="uk-width-1-2@s">
                                    ...
                                    <div class="uk-form-controls">
                                        <div class="uk-inline uk-width-1-1">
                                            <span class="uk-form-icon uk-form-icon-flip"><i class="fas fa-server"></i></span>
                                ...
                                <div class="uk-width-1-2@s">
                                    ...
                                    <div class="uk-form-controls">
                                        <select class="uk-select" id="maintenance_mode">
                                            <option value="0" <?php if ($this->config->item('maintenance_mode') == '0') {
                                                echo 'selected';
                                            } ?>><?= $this->lang->line('option_disabled'); ?></option>
                                            <option value="1" <?php if ($this->config->item('maintenance_mode') == '1') {
                                                echo 'selected';
