                ...
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <select class="uk-select" id="down_category">
                      ...
                      <option value="1" <?php if ($this->admin_model->getDownloadSpecifyCategory($idlink) == '1') {
                          echo 'selected';
                      } ?>>Client</option>
                      <option value="2" <?php if ($this->admin_model->getDownloadSpecifyCategory($idlink) == '2') {
                          echo 'selected';
                      } ?>>Addon</option>
                    </select>
                  </div>
                ...
                <div class="uk-inline uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <select class="uk-select" id="down_type">
                      ...
                      <option value="Rar" <?php if ($this->admin_model->getDownloadSpecifyType($idlink) == 'Rar') {
                          echo 'selected';
                      } ?>>Rar</option>
                      <option value="Zip" <?php if ($this->admin_model->getDownloadSpecifyType($idlink) == 'Zip') {
                          echo 'selected';
                      } ?>>Zip</option>
                    </select>
                  </div>
    ...
    var csrfHash = "<?= $this->security->get_csrf_hash() ?>";
      ...
      function UpdateDownloadForm(e) {
        ...
        $.ajax({
          ...
          method:"POST",
          data:{id, fileName, url, image, category, weight, type, [globalThis.csrfName]: globalThis.csrfHash},
          dataType:"text",
          beforeSend: function(){
            $.amaran({
              'theme': 'awesome info',
