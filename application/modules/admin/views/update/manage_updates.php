    ...
    <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
            <div class="uk-width-expand uk-heading-line">
                <h3 class="uk-h3"><i class="fas fa-cog"></i> <?= $this->config->item('website_name'); ?></h3>
            </div>
                        ...
                        <div class="uk-card uk-card-default uk-card-body">
                            <div class="uk-overflow-auto uk-margin">
                                <table class="uk-table uk-table-divider uk-table-small">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="uk-text-bold"><?= $this->lang->line('cms_possible_webserver'); ?></td>
                                            <td><?= $this->update_model->getWebServer(); ?></td>
                                        </tr>
                                        <tr>
...
<script>
    ...
    */ ?>
    ...
    function UpdateCMS(e) {
        ...
        //This feature is incomplete, just returning an infobox temporarily
        $.amaran({
            'theme': 'awesome error',
            'content': {
                title: '<?= $this->lang->line('notification_title_error'); ?>',
                message: '<?= $this->lang->line('notification_cms_update_disabled'); ?>',
                info: '',
        ...
        $.ajax({
          ...
          method:"POST",
          data:{[globalThis.csrfName]: globalThis.csrfHash},
          dataType:"text",
          beforeSend: function(){
            $.amaran({
              'theme': 'awesome info',
