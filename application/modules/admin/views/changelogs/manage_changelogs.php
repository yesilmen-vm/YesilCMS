      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          <div class="uk-width-expand uk-heading-line">
            <h3 class="uk-h3"><i class="fas fa-scroll"></i> <?= $this->lang->line('admin_nav_changelogs'); ?></h3>
          </div>
        ...
        <div class="uk-card uk-card-default uk-card-body">
                ...
                <tr>
                  ...
                  <td>
                    <div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
                      ...
                      <button class="uk-button uk-button-danger" value="<?= $changelogs->id ?>" id="button_delete<?= $changelogs->id ?>" onclick="DeleteChangelog(event, this.value)"><i class="fas fa-trash-alt"></i></button>
                    </div>
                  </td>
                </tr>
                <?php endforeach; ?>
          ...
          <div class="uk-card-footer">
            <div class="uk-text-right">
              <?php if (isset($changelogsList) && is_array($changelogsList)) {
    ...
    var csrfHash = "<?= $this->security->get_csrf_hash() ?>";
      ...
      function DeleteChangelog(e, value) {
        e.preventDefault();
        ...
        $.ajax({
          ...
          success:function(response){
            ...
            window.location.replace("<?= base_url('admin/changelogs'); ?>");
          }
        });
      }
    </script>
