      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
          ...
          <div class="uk-width-auto">
            <a href="<?= base_url('admin/forum/elements'); ?>" class="uk-icon-button"><i class="fas fa-arrow-left"></i></a>
          </div>
        </div>
              ...
              <div class="uk-margin-small">
                ...
                <div class="uk-form-controls">
                  <select class="uk-select" id="forum_type">
                    ...
                    <option value="1" <?php if ($this->admin_model->getSpecifyForumType($idlink) == '1') {
                        echo 'selected';
                    } ?>><?= $this->lang->line('option_everyone'); ?></option>
                    <option value="2" <?php if ($this->admin_model->getSpecifyForumType($idlink) == '2') {
                        echo 'selected';
                    } ?>><?= $this->lang->line('option_staff'); ?></option>
                    <option value="3" <?php if ($this->admin_model->getSpecifyForumType($idlink) == '3') {
                        echo 'selected';
                    } ?>><?= $this->lang->line('option_all'); ?></option>
                  </select>
                </div>
              </div>
              <div class="uk-margin-small">
    ...
    var csrfHash = "<?= $this->security->get_csrf_hash() ?>";
      ...
      function UpdateForumForm(e) {
        ...
        $.ajax({
          ...
          method:"POST",
          data:{id, name, description, icon, type, category, [globalThis.csrfName]: globalThis.csrfHash},
          dataType:"text",
          beforeSend: function(){
            $.amaran({
              'theme': 'awesome info',
