    <div id="editTopic" uk-modal="bg-close: false">
      <div class="uk-modal-dialog">
        ...
        <?= form_open('', 'id="topicupdateform" onsubmit="TopicUpdateForm(event)"'); ?>
            ...
            <div class="uk-margin uk-light">
              ...
              <div class="uk-form-controls">
                <div class="uk-inline uk-width-1-1">
                  ...
                  <input class="uk-input" name="edit_title" id="update_title" value="<?= $this->forum_model->getTopicTitle($idlink); ?>" type="text" placeholder="<?= $this->forum_model->getTopicTitle($idlink); ?>" required>
                </div>
              </div>
            </div>
            <div class="uk-margin uk-light">
              ...
              <div class="uk-form-controls">
                <div class="uk-width-1-1">
                  <textarea class="uk-textarea tinyeditor" name="edit_description" id="update_description" rows="10" cols="80"><?= $this->forum_model->getTopicContent($idlink); ?></textarea>
                </div>
              </div>
            </div>
