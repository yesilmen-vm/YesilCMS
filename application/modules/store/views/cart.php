                    ...
                    <td>
                      <div class="uk-form-controls uk-light">
                        <select class="uk-select uk-width-1-1" onchange="updateCharacter(this, '<?php echo $item["rowid"]; ?>')">
                          ...
                          <option value="<?= $listchar->guid ?>" <?php if ($listchar->guid == $item["guid"]) {
                              echo 'selected';
                          } ?>><?= $listchar->name ?> - (<?= $this->lang->line('table_header_realm'); ?>: <?= $this->wowrealm->getRealmName($this->store_model->getCategoryRealmId($item["category"])); ?>)</option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </td>
