...
class Migration_create_menu extends CI_Migration
{
    public function up()
    {
        ...
        $data = array(
            ...
            array('name' => 'Donate', 'url' => 'donate', 'icon' => 'fas fa-hand-holding-dollar', 'main' => '1', 'child' => '5', 'type' => '1'),
            array('name' => 'Vote', 'url' => 'vote', 'icon' => 'fas fa-check-to-slot', 'main' => '1', 'child' => '5', 'type' => '1'),
            array('name' => 'Store', 'url' => 'store', 'icon' => 'fas fa-store', 'main' => '1', 'child' => '5', 'type' => '1'),
            array('name' => 'Bugtracker', 'url' => 'bugtracker', 'icon' => 'fas fa-bug', 'main' => '1', 'child' => '5', 'type' => '1'),
            array('name' => 'Changelogs', 'url' => 'changelogs', 'icon' => 'fas fa-scroll', 'main' => '1', 'child' => '5', 'type' => '1'),
            array('name' => 'Download', 'url' => 'download', 'icon' => 'fas fa-download', 'main' => '1', 'child' => '5', 'type' => '1'),
