...
?>
<main>
    <svg class="um-cog" xmlns="http://www.w3.org/2000/svg" width="200" height="140" viewBox="0 0 100 68">
        <g id="large">
    ...
    <h1 class="um-1">UNDER MAINTANANCE</h1>
    <h2 class="um-2">Sorry for the inconvenience.</h2>
    <h3 class="um-3">You are probably seeing this page because of an update on the server or system. Please try again after a while.</h3>
</main>