...
<body>
        ...
        <div class="uk-container">
            <nav class="uk-navbar" uk-navbar>
                <div class="uk-navbar-left">
                    <a class="uk-navbar-item uk-logo" href="<?= base_url('admin'); ?>"><?= $this->config->item('website_name'); ?></a>
                </div>
            ...
            <div id="admin-mobile" data-uk-offcanvas="overlay: true">
                <div class="uk-offcanvas-bar">
                    <div class="sidebar-head uk-text-center">
                        <a class="uk-logo" href="<?= base_url('admin'); ?>"><?= $this->config->item('website_name'); ?></a>
                    ...
                    <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
                        ...
                        <li class="uk-parent">
                            ...
                            <ul class="uk-nav-sub">
                                ...
                                <li><a href="<?= base_url('admin/timeline'); ?>"><span class="admin-subnav-icon"><i class="fas fa-timeline"></i></span><?= $this->lang->line('admin_nav_timeline'); ?></a></li>
                            </ul>
                        </li>
                        <li class="uk-parent">
            ...
            <div class="uk-navbar" uk-navbar="mode: click">
                <div class="uk-navbar-left">
                    <ul class="uk-navbar-nav">
                        ...
                        <li><a href="<?= base_url('admin/tickets'); ?>"><span class="admin-subnav-icon"><i class="fas fa-scroll"></i></span><?= $this->lang->line('admin_nav_Tickets'); ?></a></li>
                        <li>
                            <a href="javascript:void(0)"><span class="uk-margin-small-right"><i class="fas fa-box"></i></span><?= $this->lang->line('admin_nav_system_logs'); ?><span class="uk-margin-xsmall-top" uk-icon="icon: triangle-down"></span></a>
                            <div class="uk-navbar-dropdown">
                                <ul class="uk-nav uk-navbar-dropdown-nav">
    ...
    <section class="uk-section uk-section-xsmall">
        <div class="uk-container uk-container-expand">
            <hr class="uk-hr">
            <p class="uk-text-small uk-text-center uk-text-right@s">Copyright <i class="far fa-copyright"></i> <?= date('Y'); ?> <span class="uk-text-bold"><?= $this->config->item('website_name'); ?></span>. <?= $this->lang->line('footer_rights'); ?> <small><br />Powered by BlizzCMS. Version: <a href="<?= base_url('admin/cms') ?>"><?= $this->update_model->getCurrentVersion(); ?></a></small></p>
        </div>
    </section>
    <script src="<?= base_url('assets/core/js/jquery.countTo.js'); ?>"></script>
    <script type="text/javascript">
        $('.blizzcms-count').countTo();
    </script>
